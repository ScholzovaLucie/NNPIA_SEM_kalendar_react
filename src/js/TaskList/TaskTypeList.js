...
function TaskTypeList({ user, setTypesGlobal }) {
    ...
    const onDelete = (id) => {
        apiService.delete('removeTypeTask', { id: id, username: user['username'] })
          .then((data) => {
            setTypes(data);
            setTypesGlobal(data);
          })
      ...
      const handleSubmit = async (e) => {
        ...
        await apiService.post('updateTypeTask', {
      ...
      const newTaskSubmit = async (e) => {
        e.preventDefault();
            await apiService.put('createTypeTask', { 
                username: user['username'], 
                name: newTask['name'],
            })
            .then((data) => {
